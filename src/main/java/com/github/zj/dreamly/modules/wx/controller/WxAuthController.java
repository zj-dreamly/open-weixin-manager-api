...
import com.github.zj.dreamly.common.utils.*;
import com.github.zj.dreamly.modules.wx.entity.WxUser;
import com.github.zj.dreamly.modules.wx.form.WxH5OuthrizeForm;
...
public class WxAuthController {
    ...
    public R codeToOpenid(HttpServletResponse response,
                          @CookieValue String appid, @RequestBody WxH5OuthrizeForm form) {
        try {
            final WxMpService wxMpService = this.wxMpServiceUtil.switchoverTo(appid);
    ...
    public R codeToUserInfo(HttpServletResponse response,
                            @CookieValue String appid, @RequestBody WxH5OuthrizeForm form) {
        try {
            final WxMpService wxMpService = this.wxMpServiceUtil.switchoverTo(appid);
            WxMpOAuth2AccessToken token = wxMpService.oauth2getAccessToken(form.getCode());
